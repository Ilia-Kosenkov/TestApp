...
namespace TestApp.Test
{
	...
	public class ScheduleTests
	{
		...
		[Test]
		[TestCase ("2000.01.01 00:00:00.000", "2100-12-31 23:59:59.999", "2000-01-01 00:00:00.000")] // макс. количество итераций при проверке
		[TestCase ("*.*.* * *:*:*.*", "2000-01-01 00:00:00.001", "2000-01-01 00:00:00.001")] // "*.*.* * *:*:*.*" (раз в 1 мс)
		[TestCase ("*.*.* * *:*:*.*", "2100-12-31 23:59:59.999", "2100-12-31 23:59:59.999")]
		[TestCase ("*.*.* 1,3,5 *:*:*.*", "2021-08-02 00:00:00.500", "2021-08-02 00:00:00.500")] // 1,2,3-5,10-20/3 означает список 1,2,3,4,5,10,13,16,19
		[TestCase ("*.*.* 1,3,5 *:*:*.*", "2021-08-05 00:00:00.500", "2021-08-04 23:59:59.999")]
		[TestCase ("*.*.* * *:*:*.1,2,3-5,10-20/3", "2020-01-01 00:00:00.013", "2020-01-01 00:00:00.013")]
		[TestCase ("*.*.* * *:*:*.1,2,3-5,10-20/3", "2021-01-01 00:00:00.000", "2020-12-31 23:59:59.019")]
		[TestCase ("*.*.* * */4:*:*", "2020-01-01 00:00:00.000", "2020-01-01 00:00:00.000")] // (для часов) */4 означает 0,4,8,12,16,20
		[TestCase ("*.*.* * */4:*:*", "2021-01-01 05:50:00.000", "2021-01-01 04:59:59.000")]
		[TestCase ("*.9.*/2 1-5 10:00:00.000", "2020-09-03 10:00:00.000", "2020-09-03 10:00:00.000")] // *.9.*/2 1-5 10:00:00.000 означает 10:00 во все дни с пн. по пт. по нечетным числам в сентябре
		[TestCase ("*.9.*/2 1-5 10:00:00.000", "2021-09-01 09:59:59.999", "2020-09-29 10:00:00.000")]
		[TestCase ("*:00:00", "2020-01-01 00:00:00.000", "2020-01-01 00:00:00.000")] // *:00:00 означает начало любого часа
		[TestCase ("*:00:00", "2021-01-01 23:59:59.999", "2021-01-01 23:00:00.000")]
		[TestCase ("*.*.01 01:30:00", "2020-01-01 01:30:00.000", "2020-01-01 01:30:00.000")] // *.*.01 01:30:00 означает 01:30 по первым числам каждого месяца
		[TestCase ("*.*.01 01:30:00", "2021-01-01 01:29:59.999", "2020-12-01 01:30:00.000")]
		[TestCase ("*.*.32 12:00:00", "2020-01-31 12:00:00.000", "2020-01-31 12:00:00.000")] // 32-й день означает последнее число месяца
		[TestCase ("*.*.32 12:00:00", "2020-03-29 00:00:00.000", "2020-02-29 12:00:00.000")]
		...
		[Test]
		[TestCase ("2000.01.01 00:00:00.000", "2100-12-31 23:59:59.999", "2000-01-01 00:00:00.000")] // макс. количество итераций при проверке
		[TestCase ("*.*.* * *:*:*.*", "2000-01-01 00:00:00.001", "2000-01-01 00:00:00.000")] // "*.*.* * *:*:*.*" (раз в 1 мс)
		[TestCase ("*.*.* * *:*:*.*", "2021-01-01 00:00:00.000", "2020-12-31 23:59:59.999")]
		[TestCase ("*.*.* 1,3,5 *:*:*.*", "2021-08-04 00:00:00.000", "2021-08-02 23:59:59.999")] // 1,2,3-5,10-20/3 означает список 1,2,3,4,5,10,13,16,19
		[TestCase ("*.*.* 1,3,5 *:*:*.*", "2021-08-05 00:00:00.500", "2021-08-04 23:59:59.999")]
		[TestCase ("*.*.* * *:*:*.1,2,3-5,10-20/3", "2020-01-01 00:00:00.013", "2020-01-01 00:00:00.010")]
		[TestCase ("*.*.* * *:*:*.1,2,3-5,10-20/3", "2021-01-01 00:00:00.000", "2020-12-31 23:59:59.019")]
		[TestCase ("*.*.* * */4:*:*", "2021-01-01 00:00:00.000", "2020-12-31 20:59:59.000")] // (для часов) */4 означает 0,4,8,12,16,20
		[TestCase ("*.*.* * */4:*:*", "2021-01-01 05:50:00.000", "2021-01-01 04:59:59.000")]
		[TestCase ("*.9.*/2 1-5 10:00:00.000", "2020-09-01 10:00:00.000", "2019-09-27 10:00:00.000")] // *.9.*/2 1-5 10:00:00.000 означает 10:00 во все дни с пн. по пт. по нечетным числам в сентябре
		[TestCase ("*.9.*/2 1-5 10:00:00.000", "2021-09-01 09:59:59.999", "2020-09-29 10:00:00.000")]
		[TestCase ("*:00:00", "2020-01-01 00:00:00.000", "2019-12-31 23:00:00.000")] // *:00:00 означает начало любого часа
		[TestCase ("*:00:00", "2021-01-01 23:59:59.999", "2021-01-01 23:00:00.000")]
		[TestCase ("*.*.01 01:30:00", "2020-01-01 01:30:00.000", "2019-12-01 01:30:00.000")] // *.*.01 01:30:00 означает 01:30 по первым числам каждого месяца
		[TestCase ("*.*.01 01:30:00", "2021-01-01 01:29:59.999", "2020-12-01 01:30:00.000")]
		[TestCase ("*.*.32 12:00:00", "2021-03-31 12:00:00.000", "2021-02-28 12:00:00.000")] // 32-й день означает последнее число месяца
		[TestCase ("*.*.32 12:00:00", "2020-03-29 00:00:00.000", "2020-02-29 12:00:00.000")]
